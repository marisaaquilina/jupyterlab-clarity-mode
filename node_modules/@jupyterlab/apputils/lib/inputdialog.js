...
(function (InputDialog) {
    ...
    function getBoolean(options) {
        return showDialog(Object.assign({}, options, { body: new InputBooleanDialog(options), buttons: [
    ...
    function getNumber(options) {
        return showDialog(Object.assign({}, options, { body: new InputNumberDialog(options), buttons: [
                Dialog.cancelButton({ label: options.cancelLabel }),
                Dialog.okButton({ label: options.okLabel })
            ], focusNodeSelector: 'input' }));
    }
    ...
    function getItem(options) {
        return showDialog(Object.assign({}, options, { body: new InputItemsDialog(options), buttons: [
                Dialog.cancelButton({ label: options.cancelLabel }),
                Dialog.okButton({ label: options.okLabel })
    ...
    function getText(options) {
        return showDialog(Object.assign({}, options, { body: new InputTextDialog(options), buttons: [
                Dialog.cancelButton({ label: options.cancelLabel }),
                Dialog.okButton({ label: options.okLabel })
            ], focusNodeSelector: 'input' }));
    }
