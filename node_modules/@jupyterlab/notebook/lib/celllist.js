...
import { ArrayExt, each, toArray, ArrayIterator } from '@phosphor/algorithm';
...
export class CellList {
     ...
     */
    removeValue(cell) {
        let index = ArrayExt.findFirstIndex(toArray(this._cellOrder), id => this._cellMap.get(id) === cell);
        this.remove(index);
        return index;
    }
    /**
