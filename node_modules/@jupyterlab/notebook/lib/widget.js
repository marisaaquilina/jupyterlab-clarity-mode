...
(function (StaticNotebook) {
    ...
    StaticNotebook.defaultEditorConfig = {
        code: Object.assign({}, CodeEditor.defaultConfig, { lineWrap: 'off', matchBrackets: true, autoClosingBrackets: true }),
        markdown: Object.assign({}, CodeEditor.defaultConfig, { lineWrap: 'on', matchBrackets: false, autoClosingBrackets: false }),
        raw: Object.assign({}, CodeEditor.defaultConfig, { lineWrap: 'on', matchBrackets: false, autoClosingBrackets: false })
    };
    /**
        ...
        if (this.model && this.model.modelDB.isCollaborative) {
            ...
            void modelDB.connected.then(() => {
                if (!cell.isDisposed) {
                    ...
                    cell.editor.selectionStyle = Object.assign({}, CodeEditor.defaultSelectionStyle, { color: localCollaborator.color });
                }
            });
        }
