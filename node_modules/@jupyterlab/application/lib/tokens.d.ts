 ...
 */
export declare const IConnectionLost: Token<IConnectionLost>;
/**
 ...
 * actions.
 */
export declare type IConnectionLost = (manager: ServiceManager.IManager, err: ServerConnection.NetworkError) => Promise<void>;
/**
