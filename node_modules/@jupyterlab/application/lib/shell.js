...
import { ArrayExt, find, iter, toArray } from '@phosphor/algorithm';
import { PromiseDelegate, Token } from '@phosphor/coreutils';
import { MessageLoop } from '@phosphor/messaging';
import { Signal } from '@phosphor/signaling';
import { BoxLayout, BoxPanel, DockPanel, FocusTracker, Panel, SplitPanel, StackedPanel, TabBar, Widget } from '@phosphor/widgets';
/**
...
export class LabShell extends Widget {
    ...
    set mode(mode) {
        ...
        widgets.forEach(widget => {
            if (!widget.parent) {
                this._addToMainArea(widget, Object.assign({}, this._mainOptionsCache.get(widget), { activate: false }));
            }
        });
    ...
    _addToMainArea(widget, options) {
        ...
        widget.title.dataset = Object.assign({}, widget.title.dataset, { id: widget.id });
