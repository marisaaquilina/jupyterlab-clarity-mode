...
export declare namespace KernelMessage {
    ...
    function createMessage<T extends IClearOutputMsg>(options: IOptions<T>): T;
    function createMessage<T extends ICommCloseMsg<'iopub'>>(options: IOptions<T>): T;
    function createMessage<T extends ICommCloseMsg<'shell'>>(options: IOptions<T>): T;
    function createMessage<T extends ICommInfoReplyMsg>(options: IOptions<T>): T;
    function createMessage<T extends ICommInfoRequestMsg>(options: IOptions<T>): T;
    function createMessage<T extends ICommMsgMsg<'iopub'>>(options: IOptions<T>): T;
    function createMessage<T extends ICommMsgMsg<'shell'>>(options: IOptions<T>): T;
    function createMessage<T extends ICommOpenMsg<'iopub'>>(options: IOptions<T>): T;
    function createMessage<T extends ICommOpenMsg<'shell'>>(options: IOptions<T>): T;
    function createMessage<T extends ICompleteReplyMsg>(options: IOptions<T>): T;
    function createMessage<T extends ICompleteRequestMsg>(options: IOptions<T>): T;
    function createMessage<T extends IDisplayDataMsg>(options: IOptions<T>): T;
    function createMessage<T extends IErrorMsg>(options: IOptions<T>): T;
    function createMessage<T extends IExecuteInputMsg>(options: IOptions<T>): T;
    function createMessage<T extends IExecuteReplyMsg>(options: IOptions<T>): T;
    function createMessage<T extends IExecuteRequestMsg>(options: IOptions<T>): T;
    function createMessage<T extends IExecuteResultMsg>(options: IOptions<T>): T;
    function createMessage<T extends IHistoryReplyMsg>(options: IOptions<T>): T;
    function createMessage<T extends IHistoryRequestMsg>(options: IOptions<T>): T;
    function createMessage<T extends IInfoReplyMsg>(options: IOptions<T>): T;
    function createMessage<T extends IInfoRequestMsg>(options: IOptions<T>): T;
    function createMessage<T extends IInputReplyMsg>(options: IOptions<T>): T;
    function createMessage<T extends IInputRequestMsg>(options: IOptions<T>): T;
    function createMessage<T extends IInspectReplyMsg>(options: IOptions<T>): T;
    function createMessage<T extends IInspectRequestMsg>(options: IOptions<T>): T;
    function createMessage<T extends IIsCompleteReplyMsg>(options: IOptions<T>): T;
    function createMessage<T extends IIsCompleteRequestMsg>(options: IOptions<T>): T;
    function createMessage<T extends IStatusMsg>(options: IOptions<T>): T;
    function createMessage<T extends IStreamMsg>(options: IOptions<T>): T;
    function createMessage<T extends IUpdateDisplayDataMsg>(options: IOptions<T>): T;
    /**
     * Shell message types.
     */
    type ShellMessageType = 'comm_close' | 'comm_info_reply' | 'comm_info_request' | 'comm_msg' | 'comm_open' | 'complete_reply' | 'complete_request' | 'execute_reply' | 'execute_request' | 'history_reply' | 'history_request' | 'inspect_reply' | 'inspect_request' | 'interrupt_reply' | 'interrupt_request' | 'is_complete_reply' | 'is_complete_request' | 'kernel_info_reply' | 'kernel_info_request' | 'shutdown_reply' | 'shutdown_request';
    /**
     ...
     */
    interface IShellMessage<T extends ShellMessageType = ShellMessageType> extends IMessage<T> {
        channel: 'shell';
    }
    /**
     ...
     */
    interface IIOPubMessage<T extends IOPubMessageType = IOPubMessageType> extends IMessage<T> {
        channel: 'iopub';
    }
    /**
     * A kernel message on the `'stdin'` channel.
     */
    interface IStdinMessage<T extends StdinMessageType = StdinMessageType> extends IMessage<T> {
        channel: 'stdin';
    }
     ...
     */
    interface ICommOpenMsg<T extends 'shell' | 'iopub' = 'iopub' | 'shell'> extends IMessage<'comm_open'> {
        channel: T;
        content: {
            comm_id: string;
            target_name: string;
     ...
     */
    function isCommCloseMsg(msg: IMessage): msg is ICommCloseMsg<'iopub' | 'shell'>;
    /**
     ...
     */
    interface ICommMsgMsg<T extends 'iopub' | 'shell' = 'iopub' | 'shell'> extends IMessage<'comm_msg'> {
        channel: T;
        content: {
            comm_id: string;
            data: JSONObject;
     ...
     */
    function isInfoRequestMsg(msg: IMessage): msg is IInfoRequestMsg;
    /**
     ...
     */
    function isInputReplyMsg(msg: IMessage): msg is IInputReplyMsg;
}
