...
import { ArrayExt, ArrayIterator, each, empty, find, map } from '@phosphor/algorithm';
...
(function (DocumentRegistry) {
     ...
     */
    DocumentRegistry.defaultDirectoryFileType = Object.assign({}, DocumentRegistry.fileTypeDefaults, { name: 'directory', extensions: [], mimeTypes: ['text/directory'], contentType: 'directory', iconClass: 'jp-MaterialIcon jp-FolderIcon' });
    /**
