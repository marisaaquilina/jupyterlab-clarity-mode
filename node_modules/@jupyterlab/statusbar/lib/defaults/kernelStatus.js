...
function KernelStatusComponent(props) {
    return (React.createElement(TextItem, { onClick: props.handleClick, source: `${Text.titleCase(props.kernelName)} | ${Text.titleCase(props.status)}`, title: `Change kernel for ${props.activityName}` }));
}
/**
