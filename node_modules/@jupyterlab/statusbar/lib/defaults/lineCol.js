...
import { lineFormWrapper, lineFormInput, lineFormSearch, lineFormWrapperFocusWithin, lineFormCaption, lineFormButton } from '../style/lineForm';
    ...
    render() {
        return (React.createElement("div", { className: lineFormSearch },
            React.createElement("form", { name: "lineColumnForm", onSubmit: this._handleSubmit, noValidate: true },
                React.createElement("div", { className: classes(lineFormWrapper, 'p-lineForm-wrapper', this.state.hasFocus ? lineFormWrapperFocusWithin : undefined) },
                    ...
                    React.createElement("input", { type: "submit", className: classes(lineFormButton, 'jp-StatusItem-line-form'), value: "" })),
